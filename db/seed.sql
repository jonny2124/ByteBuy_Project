...
('ph1','Samsung Galaxy S25','Samsung Galaxy S25',899.00, FLOOR(RAND()*50)+1,'assets/products/SamsungGalaxyS25.jpg'),
('ph2','iPhone 17','iPhone 17',999.00, FLOOR(RAND()*50)+1,'assets/products/iphone17.jpg'),
('ph3','Google Pixel 10','Google Pixel 10',799.00, FLOOR(RAND()*50)+1,'assets/products/GooglePixel10.png'),
('ph4','OnePlus 15','OnePlus 15',749.00, FLOOR(RAND()*50)+1,'assets/products/Oneplus15.jpg'),
('ph5','Xiaomi 13T','Xiaomi 13T',599.00, FLOOR(RAND()*50)+1,'assets/products/Xiaomi15.jpg'),
('ph6','Nothing Phone 3','Nothing Phone 3',799.00, FLOOR(RAND()*50)+1,'assets/products/Nothingphone3.jpg'),
('ph7','iPhone 16','iPhone 16',799.00, FLOOR(RAND()*50)+1,'assets/products/iphone16.png'),
...
('au3','Bose Quiet Comfort','Bose Quiet Comfort',349.00, FLOOR(RAND()*50)+1,'assets/products/BoseQuietComfort.jpg'),
